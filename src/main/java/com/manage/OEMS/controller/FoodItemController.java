...
public class FoodItemController {
	...
	public List<FoodItem> getFoodItemsByVenueId(@PathVariable int venueId) {
	...
	public FoodItem getFoodItem(@PathVariable int foodItemId) {
	...
	public int deleteFoodItem(@PathVariable int foodItemId) {
