...
public class BookingController {
	...
	public List<BookingDetail> getBookingsByOrgId(@PathVariable int orgId) {
	...
	public List<BookingDetail> getPreviousBookingsByOrgId(@PathVariable int orgId) {
	...
	public List<Date> getDates(@PathVariable int venueId) {
	...
	public int checkActiveBookings(@PathVariable int venueId) {
